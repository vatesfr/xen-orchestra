...
- [Backup NG] Make the Backup NG job fail when it contains a not existent VM [#3434](https://github.com/vatesfr/xen-orchestra/issues/3434) (PR [#3522](https://github.com/vatesfr/xen-orchestra/pull/3522))
