...
- [ACL] Fix user with ACLs on a snapshot should be able to manage it, related to [#3443](https://github.com/vatesfr/xen-orchestra/issues/3443) (PR [#3480](https://github.com/vatesfr/xen-orchestra/pull/3480))
