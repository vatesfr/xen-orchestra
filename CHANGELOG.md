...
- [travis] Run tests on all files that differs from master on PR [#2703](https://github.com/vatesfr/xen-orchestra/issues/2703) (PR [#3599](https://github.com/vatesfr/xen-orchestra/pull/3599))
