    ...
    hostMonitors: {
      ...
      items: {
        ...
        properties: {
          ...
          uuids: {
            description:
              'List of hosts to monitor if "All running hosts" is enabled, or to not monitor if "Exclude hosts" is enabled.',
            title: 'Hosts',
            type: 'array',
            items: {
              type: 'string',
    ...
    vmMonitors: {
      ...
      items: {
        ...
        properties: {
          ...
          uuids: {
            description:
              'List of VMs to monitor if "All running VMs" is enabled, or to not monitor if "Exclude VMs" is enabled.',
    ...
    srMonitors: {
      ...
      items: {
        ...
        properties: {
          ...
          uuids: {
            description:
              'List of SRs to monitor if "All SRs" is enabled, or to not monitor if "Exclude SRs" is enabled.',
            title: 'SRs',
            type: 'array',
            items: {
              type: 'string',
