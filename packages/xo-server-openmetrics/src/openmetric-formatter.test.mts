 ...
 *
 * Covers the XOSTOR formatters that still live in `openmetric-formatter.mts`
 * and the `indexSrUuidTruncations` helper. The RRD/entity/primitive/definition
 * formatters are tested under `./formatter/*.test.mts`.
 */
...
import type { XostorAlarmsItem, XostorClusterItem, XostorSmartHost, XostorUpdateItem } from './index.mjs'
