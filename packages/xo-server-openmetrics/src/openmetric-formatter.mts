 ...
 * under `./formatter/`, plus the XOSTOR formatters that still live here.
 */

import type { HostStatusItem, SrDataItem, VdiDataItem, VmStatusItem, XoMetricsData } from './types/domain.mjs'
import type {
  XostorAlarmEntry,
  XostorAlarmsItem,
  XostorAlarmsPayload,
