...
test('computeChecksum() is correct against some reference values', () => {
  ...
  expect(computeChecksum(Buffer.from(testValue1, 'hex'))).toEqual(
    expectedChecksum1
  )
  expect(computeChecksum(Buffer.from(testValue2, 'hex'))).toEqual(
    expectedChecksum2
  )
})
