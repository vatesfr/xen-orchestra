...
`
  ...
  // virtual box add some additionnal properties to te descriptor like :
  ...
  // but does not ensure there is enough free room and  overwrite the data (the grain directory)
  // broking the file
