...
export const isCrBackup = backup => backup.mode === 'delta' && !isEmpty(get(() => destructPattern(backup.srs)))
export const isDrBackup = backup => backup.mode === 'full' && !isEmpty(get(() => destructPattern(backup.srs)))
