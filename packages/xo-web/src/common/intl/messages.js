...
const messages = {
  ...
  installAllPatchesOnHostContent:
    'The pool master must always be updated FIRST. This will automatically restart the toolstack. Running VMs will not be affected. Are you sure you want to continue and install all patches on this host?',
