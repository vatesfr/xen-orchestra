...
const messages = {
  ...
  // ----- XOSTOR -----
  approximativeFinalSize: 'Approximative final size',
  cantFetchDisksFromNonXcpngHost: 'Unable to fetch physical disks from non-XCP-ng host',
  diskAlreadyMounted: 'The disk is mounted to: {mountpoint}',
  diskHaveChildren: 'The disk have children',
  ...
  poolAlreadyHaveXostor: 'Pool already have a XOSTOR',
  replication: 'Replication',
  resume: 'Resume',
  selectDisks: 'Select disk(s)…',
  selectedDiskTypeIncompatibleXostor: "Only disk of type: 'Disk' and 'Raid' are accepted. Selected disk type: {type}",
  storage: 'Storage',
  wrongNumberOfHosts: 'Wrong number of hosts',
  xostor: 'XOSTOR',
  xostorDiskRequired: 'At least one disk is required',
  xostorDisksDropdownLabel: '({nDisks, number} disk{nDisks, plural, =0 {} one {} other {s}}) {hostname}',
  xostorPackagesWillBeInstalled: 'On each hosts, "xcp-ng-release-linstor" and "xcp-ng-linstor" will be installed',
  xostorReplicationWarning: 'If a disk die, you will loose the data',
