...
const messages = {
  ...
  missingRetentions: 'The modes need at least a schedule with retention greater than 0',
  missingExportRetention: 'The Backup mode and the Delta Backup mode require backup retention to be greater than 0!',
  missingCopyRetention: 'The CR mode and The DR mode require replication retention to be greater than 0!',
  missingSnapshotRetention: 'The Rolling Snapshot mode requires snapshot retention to be greater than 0!',
  deltaChainRetentionWarning: 'Either the full backup interval or the backup retention should be lower than 50.',
  retentionNeeded: 'Requires one retention to be greater than 0!',
  ...
  deleteAuthTokensConfirmMessage:
    'Are you sure you want to delete {nTokens, number} authentication token{nTokens, plural, one {} other {s}}?',
  ...
  replicationCountHigherThanHostsWithDisks: 'Replication count is greater than number of hosts with disks',
  ...
  xcpngLicensesBindingAdvancedView: "To bind an XCP-ng license, go to the pool's Advanced tab.",
  ...
  highestCpuTemperature: '{n, number}x CPU{n, plural, one {} other {s}} (highest: {degrees})',
