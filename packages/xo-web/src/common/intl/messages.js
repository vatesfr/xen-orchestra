...
const messages = {
  ...
  securebootStatus: 'SecureBoot enforced',
  securebootStatusNoDbx: 'SecureBoot enforced, but no dbx present.',
  securebootStatusNotEnforced: 'SecureBoot not enforced',
  securebootStatusPending: 'SecureBoot enforced, pending first boot',
  securebootWantedButCertificatesMissing: 'SecureBoot wanted, but some EFI certificates are missing',
  securebootWantedButDisabled: 'SecureBoot wanted, but disabled due to the VM being in UEFI setup mode',
  started: 'Started {ago}',
