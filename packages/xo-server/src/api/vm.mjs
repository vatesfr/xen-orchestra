...
export function warmMigration({ vm, sr, startDestinationVm, deleteSourceVm }) {
  return this.warmMigrateVm(vm, sr, startDestinationVm, deleteSourceVm)
}
...
set.params = {
  ...
  cpuMask: { type: 'array', items: { type: 'integer' }, optional: true },
