...
export const NETWORK_ADMINISTRATOR = {
  ...
  privileges: [
    // Networks
    { action: 'read', resource: 'network', effect: 'allow' },
    { action: 'create', resource: 'network', effect: 'allow' },
    { action: 'delete', resource: 'network', effect: 'allow' },
    { action: 'update:tags', resource: 'network', effect: 'allow' },
    ...
    { action: 'read', resource: 'pif', effect: 'allow' },
    // Virtual interfaces (VM side): full lifecycle
    { action: 'read', resource: 'vif', effect: 'allow' },
    { action: 'create', resource: 'vif', effect: 'allow' },
    { action: 'delete', resource: 'vif', effect: 'allow' },
    { action: 'connect', resource: 'vif', effect: 'allow' },
    { action: 'disconnect', resource: 'vif', effect: 'allow' },
