 ...
 * it turns a backup archive id + disk id + host id into a remote handler, a
 * disk path and a XAPI connection. The mounting itself lives in
...
export default class BackupDiskMountsResolver {
   ...
   * @param {string} params.host - id of the host the disk is attached to
   */
  async mountBackupArchiveDisk({ archiveId, diskId, host: hostId }) {
    const app = this.#app
