...
- Automatic generation of self signed certificate if `autoCert` is set in `xo-server`'s configuration in the corresponding `http.listen` section (PR [#4954](https://github.com/vatesfr/xen-orchestra/pull/4954))
