...
- [VM] Secure boot can be managed from the UI. Secure boot are soon available on XCP-ng [#5502](https://github.com/vatesfr/xen-orchestra/issues/5502) (PR [#5527](https://github.com/vatesfr/xen-orchestra/pull/5527))
