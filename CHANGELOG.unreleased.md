...
- [SDN Controller] Fix tunnel traffic going on the wrong NIC: see https://xcp-ng.org/forum/topic/3544/mtu-problems-with-vxlan. [xoa-support #2919] (PR [#5281](https://github.com/vatesfr/xen-orchestra/pull/5281))
