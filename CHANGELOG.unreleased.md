...
- [Xen servers] Fix "no connection found for object" error due to an unhandled pool UUID change [#4299](https://github.com/vatesfr/xen-orchestra/issues/4299) (PR [#4302](https://github.com/vatesfr/xen-orchestra/pull/4302))
