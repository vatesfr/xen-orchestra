...
- [XO6/Roles] Delete a role from its side panel in the user management page. A role assigned to users or groups cannot be deleted (PR [#10349](https://github.com/vatesfr/xen-orchestra/pull/10349))
