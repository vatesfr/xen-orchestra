...
- [Proxy] Fix non-relevant throw of the error "cannot get the proxy VM IP" on backup's execution [#4927](https://github.com/vatesfr/xen-orchestra/issues/4927) (PR [#4928](https://github.com/vatesfr/xen-orchestra/pull/4928))
