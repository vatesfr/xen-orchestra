...
- [XO6] add dedicated SR page with General (info, space, PBD details, custom fields), VDIs, and Hosts tabs (PR [#9953](https://github.com/vatesfr/xen-orchestra/pull/9953))
