...
- [REST API] Add `POST rest/v0/plugins/sdn-controller/rules/:id` and `DELETE rest/v0/plugins/sdn-controller/rules/:id` traffic rule endpoints for VIFs ([#9418](https://github.com/vatesfr/xen-orchestra/pull/9418))
