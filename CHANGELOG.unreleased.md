...
- [REST API/RBAC] Add a built-in **Network administrator** ACL role template: manage networks (create, delete, tag), create networks on a pool, manage VIFs (create, delete, connect, disconnect) and read PIFs and hosts. Copy it to create scoped network-admin roles (PR [#9952](https://github.com/vatesfr/xen-orchestra/pull/9952))
