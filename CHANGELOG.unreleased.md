...
- [VM/disk] Illegal SR: Display a warning message and a confirmation modal on attaching a disk [#3911](https://github.com/vatesfr/xen-orchestra/issues/3911) (PR [#3969](https://github.com/vatesfr/xen-orchestra/pull/3969))
### Bug fixes
