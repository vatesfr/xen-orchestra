...
- [Backup] Continue the backup on the other targets if one target(remote/SR) fails [#5353](https://github.com/vatesfr/xen-orchestra/issues/5353) (PR [#5651](https://github.com/vatesfr/xen-orchestra/pull/5651))
