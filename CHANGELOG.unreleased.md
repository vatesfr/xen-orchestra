...
- [Hub/Kubernetes] Prevent newly created cluster VMs from keeping an extra cloud-init disk used to install the Xen guest agent (PR [#10371](https://github.com/vatesfr/xen-orchestra/pull/10371))
