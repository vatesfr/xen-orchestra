...
- [Proxy] Metadata backups
  - run backups (PR [#5499](https://github.com/vatesfr/xen-orchestra/pull/5499))
  - list backups (PR [#5517](https://github.com/vatesfr/xen-orchestra/pull/5517))
