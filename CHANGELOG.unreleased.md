...
- [Backups/Mirror] Fix `xo:fs:local WARN lock compromised` when mirroring a Backup Repository to a local/NFS/samba repository ([#7043](https://github.com/vatesfr/xen-orchestra/pull/7043))
