...
- [Home/vm] Bulk intra pool migration: fixed VM VDIs not migrated to the selected SR if they are on shared SRs (PR [#3987](https://github.com/vatesfr/xen-orchestra/pull/3987))
