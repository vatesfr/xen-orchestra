...
- [REST API/RBAC] Add a built-in Backup administrator RBAC role template to administer backup jobs, schedules, repositories, archives and logs (PR [#TODO](https://github.com/vatesfr/xen-orchestra/pull/TODO))
