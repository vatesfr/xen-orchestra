...
- [XO6/Kubernetes] Add Kubernetes objects to the TreeView (PR [#10366](https://github.com/vatesfr/xen-orchestra/pull/10366))
- [XO6/Kubernetes] Add Kubernetes clusters tab and types stub pages
