...
- [Host/advanced] Fix host CPU hyperthreading detection [#4285] (https://github.com/vatesfr/xen-orchestra/issues/4285) (PR (https://github.com/vatesfr/xen-orchestra/pull/4262))
