...
- **XO 5**:
  ...
  - [tab-disks] VDI migration now shows all pool SRs for admins, even on VMs bound to a Resource Set (PR [#10422](https://github.com/vatesfr/xen-orchestra/pull/10422))
