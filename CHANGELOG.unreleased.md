...
- [@xen-orchestra/lite] Update lodash-es, rollup (transitive), postcss (transitive) (PR [#9640](https://github.com/vatesfr/xen-orchestra/pull/9640))
...
- [@xen-orchestra/web] Update lodash-es (PR [#9640](https://github.com/vatesfr/xen-orchestra/pull/9640))
