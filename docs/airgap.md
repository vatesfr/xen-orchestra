...
XO has not been initially developped to support airgapped infrastructures but the following procedures have been tested and validated to permit its support.
