...
If your backup includes both a (Delta) Backup *and* a CR/DR, you will have the option to select the number you wish for both "Backup retention"  and "Replication retention" n the Schedule configuration; make sure to assign the number you want to the correct retention.
