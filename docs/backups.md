...
:::warning
File level restore **is only possible if all the partition is in the same VDI**. It excludes file recovery on VDIs of Volume Group based on multiple Physical Volumes.
:::
