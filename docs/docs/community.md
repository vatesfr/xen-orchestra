...
1. update your XO to the latest `master` commit (see how-to in the [dedicated section](./xo5/installation.md#updating)) and retest again
2. if the issue persists, double check you have all the requirements checked from the [installation section](./xo5/installation.md#from-the-sources) and test again
...
:::tip
If you want a consistent and tested solution for using Xen Orchestra, we strongly advise using our preconfigured and validated [Xen Orchestra Virtual Appliance](./xo5/installation.md#xoa).
:::
