...
:::tip
Admin users have access to all REST API endpoints. Non-admin users can use the REST API according to the [ACL v2 / RBAC](./acl-v2.md) permissions defined on their account.
:::
