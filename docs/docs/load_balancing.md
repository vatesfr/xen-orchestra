...
This option prevents the load balancer from migrating the same VM twice in quick succession, by forcing a given delay between load-balancer-related migrations. Default to 30 minutes, set to 0 to disable it.

![The Advanced settings form](./assets/load_balancing_advanced_settings.png)
