...
Xen Orchestra includes a Kubernetes cluster [recipe](../../xo5/management/advanced#recipes) that provides a simple way to deploy an official Kubernetes distribution called **MicroK8s** (maintained by Canonical).
