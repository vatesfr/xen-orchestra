...
| `backup-archive`    | `read`                                                                                                     |
| `backup-log`        | `read`                                                                                                     |
| `backup-repository` | `create`, `read`, `forget`, `test`, `update:enabled`, `update:name`, `update:options`, `update:proxy`, `update:url` |
| `schedule`          | `read`, `run`                                                                                              |
| `restore-log`       | `read`                                                                                                     |
| `proxy`             | `read`                                                                                                     |
...
| `backup-archive`    | `read`                                                                                                                   |
| `backup-log`        | `read`                                                                                                                   |
| `backup-repository` | `benchmark`, `create`, `health`, `read`, `update:enabled`, `update:name`, `update:options`, `update:proxy`, `update:url` |
| `schedule`          | `read`, `run`                                                                                                            |
| `restore-log`       | `read`                                                                                                                   |
| `proxy`             | `read`                                                                                                                   |
| `server`            | `read`, `create`, `delete`, `connect`, `disconnect`                                                                      |
...
| `alarm`             | `read`                                                                                                                   |
| `message`           | `read`                                                                                                                   |
>>>>>>> f46dbf326 (split routes into health and benchmark)
