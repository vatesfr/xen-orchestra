...
| **Network administrator**   | Manage networks across pools, hosts and VMs: create, delete and tag networks, create networks on a pool, manage VIFs (create, delete, connect, disconnect), and read PIFs, hosts and VMs. |
