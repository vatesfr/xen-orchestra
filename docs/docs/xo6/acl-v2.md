...
| `host`          | `read`, `allow-vm`, `join-pool`, `export:logs`, `update:tags`, `migrate-receive`, `disable`, `enable`, `evacuate`, `detach`, `shutdown:clean`, `shutdown:emergency`, `forget`, `reboot:clean`, `reboot:smart`, `restart-toolstack`, `start`, `scan-pifs`, `mount-live-disk`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
...
| ------------------- | ------------------------------------------------------------------------------------------------------------------------ |
| `backup-job`        | `read`                                                                                                                   |
| `backup-archive`    | `read`, `mount-live-disk`, `unmount-live-disk`, `hydrate-live-disk`                                                      |
| `backup-log`        | `read`                                                                                                                   |
