...
- [**File restore**](/xo5/backups#restore-a-file): A feature that allows you to restore individual files from a VM backup without restoring the full VM.
...
- [**Long-term retention**](/xo5/backups#long-term-backup-retention-with-gfs-strategy): Keeps backups over extended periods (weeks, months, or years) for compliance or archival purposes.
...
- [**Remote**](/xo5/backups#remotes): A storage location for backups. For instance:
