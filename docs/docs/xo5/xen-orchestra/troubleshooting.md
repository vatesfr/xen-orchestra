...
:::warning
If you have issues with XO installed from GitHub (not XOA), [please go to the dedicated section first!](../../xo6/support/community).
:::
...
If you have lost your password to log in to the XOA webpage, you can reset it. From the XOA CLI (for login/access info for the CLI, [see here](../xoa#first-console-connection)), use the following command and insert the email/account you wish to recover:
