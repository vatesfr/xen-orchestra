...
If you need to do any configuration on the system itself (firewall, SSH…), check the [XOA dedicated section](../xoa).
...
See [XO 5 > Management > SDN Controller > OpenFlow rules](../management/sdn_controller#migration-path) for details.
