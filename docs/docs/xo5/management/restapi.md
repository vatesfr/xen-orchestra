...
:::tip
Admin users have access to all REST API endpoints. Non-admin users can use the REST API according to the [ACL v2 / RBAC](../../xo6/security/user-management/acl-v2) permissions defined on their account.
:::
