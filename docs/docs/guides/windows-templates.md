...
<UiDetail src="/img/windows-templates/overview.png" alt="Overview diagram" width={620} />
...
<UiDetail src="/img/windows-templates/1-audit1.png" alt="Windows OOBE screen" width={700} />
...
<UiDetail src="/img/windows-templates/1-audit2.png" alt="Windows in Audit mode, with Sysprep window visible" width={700} />
...
<UiDetail src="/img/windows-templates/1-copyvm.png" alt="Copy VM" width={620} />
...
<UiDetail src="/img/windows-templates/2-winpv2.png" alt="XenServer VM Tools Setup Settings" width={700} />
...
<UiDetail src="/img/windows-templates/2-cbi1.png" alt="Installing Cloudbase-init" width={700} />

Don't run Sysprep yet; you still need to configure Cloudbase-init.

<UiDetail src="/img/windows-templates/2-cbi2.png" alt="Cloudbase-init is installed, don't sysprep yet" width={700} />
...
<UiDetail src="/img/windows-templates/3-cbi.png" alt="Configuring cloudbase-init.conf" width={700} />
...
<UiDetail src="/img/windows-templates/4-sysprep.png" alt="Sysprep is running" width={700} />
...
<UiDetail src="/img/windows-templates/5-instantiate.png" alt="Create VM from template" width={700} />
...
<UiDetail src="/img/windows-templates/5-unseal.png" alt="Windows is getting ready" width={700} />

Enjoy your finished product!

<UiDetail src="/img/windows-templates/6-finish.png" alt="VM with hostname set as desired" width={700} />
