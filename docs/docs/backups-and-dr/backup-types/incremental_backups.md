...
- Each disk can be restored, left out, or [live mounted](../backup-features-and-settings.md#live-mount): attached in read-only mode to the restored VM straight from the backup, without being copied.
