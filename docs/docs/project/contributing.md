...
:::tip
Before creating an issue, please take a look [into this section](../xo6/support/community) for more details.
:::
...
2. Follow [the documentation](../xo5/xen-orchestra/installation#from-the-sources) to install and run Xen Orchestra from the sources
