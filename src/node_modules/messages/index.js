...
const messages = {
  ...
  vdiAttachDeviceButton: {
    defaultMessage: 'Attach an existing disk'
  },
  vbdCreateDeviceButton: {
    defaultMessage: 'Create a new disk'
  },
  vdiBootOrder: {
  ...
  vifCreateDeviceButton: {
    defaultMessage: 'Create a new device'
  },
  vifNoInterface: {
  ...
  snapshotCreateButton: {
    defaultMessage: 'Create a snapshot'
  },
...
localizedMessages.fr = {
  ...
  // ----- VM disk tab -----
  vdiAttachDeviceButton: 'Brancher un disque existant',
  vbdCreateDeviceButton: 'Créer un nouveau disque',
  ...
  // ----- VM network tab -----
  vifCreateDeviceButton: 'Créer une nouvelle interface',
  ...
  snapshotCreateButton: 'Créer un instantané',
