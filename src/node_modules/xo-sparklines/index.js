...
export const CpuSparkLines = propTypes({
  ...
  <Sparklines style={STYLE} data={computeArraysAvg(data)} max={100} min={0} width={WIDTH} height={HEIGHT}>
    <SparklinesLine style={{ strokeWidth: 1, stroke: '#336aff', fill: '#336aff', fillOpacity: 0.5 }} color='#3366ff'/>
    <SparklinesSpots />
  </Sparklines>
)
...
export const MemorySparkLines = propTypes({
  ...
  return (
    <Sparklines style={STYLE} data={data.memoryUsed} max={memory[memory.length - 1]} min={0} width={WIDTH} height={HEIGHT}>
...
export const XvdSparkLines = propTypes({
  ...
  <Sparklines style={STYLE} data={computeObjectsAvg(data)} min={0} width={WIDTH} height={HEIGHT}>
