...
var messages = {
  ...
  hostNeedsPatchUpdate: 'This host needs to install {patches} patch{patches, plural, one {} other {es}} before it can be added to the pool. This operation may be long.',
