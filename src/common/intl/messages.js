...
var messages = {
  ...
  // ----- Modals -----
  emergencyShutdownHostsModalTitle: 'Emergency shutdown Host{hosts, plural, one {} other {s}}',
  emergencyShutdownHostsModalMessage: 'Are you sure you want to shutdown {hosts} Host{hosts, plural, one {} other {s}}?',
  ...
  restartHostsAgentsModalTitle: 'Restart Host{hosts, plural, one {} other {s}} agent{hosts, plural, one {} other {s}}',
  restartHostsAgentsModalMessage: 'Are you sure you want to restart {hosts} Host{hosts, plural, one {} other {s}} agent{hosts, plural, one {} other {s}}?',
  restartHostsModalTitle: 'Restart Host{hosts, plural, one {} other {s}}',
  restartHostsModalMessage: 'Are you sure you want to restart {hosts} Host{hosts, plural, one {} other {s}}?',
  ...
  stopHostsModalTitle: 'Stop Host{hosts, plural, one {} other {s}}',
  stopHostsModalMessage: 'Are you sure you want to stop {hosts} Host{hosts, plural, one {} other {s}}?',
