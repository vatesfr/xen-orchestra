<template>
  ...
  >
    ...
    <VtsNoDataIllustration v-else-if="type === 'no-data'" class="image" />
...
import VtsNoDataIllustration from '@core/components/state-hero/VtsNoDataIllustration.vue'
