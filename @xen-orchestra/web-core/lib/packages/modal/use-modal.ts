...
import { type ModalConfig, type ModalHandlerArgs, type OpenModal } from '@core/packages/modal/types.ts'
...
): OpenModal<[], TConfirmPayload, TCancelPayload>
...
): OpenModal<TConfigBuilderArgs, TConfirmPayload, TCancelPayload>
...
): OpenModal<TConfigBuilderArgs, TConfirmPayload, TCancelPayload> | ReturnType<typeof createModalOpener> {
