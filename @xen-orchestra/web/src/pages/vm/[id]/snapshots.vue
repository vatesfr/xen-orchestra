...
const selectedSnapshot = useRouteQuery<XoVmSnapshot | undefined>('id', {
  toData: id => getSnapshotById(id as XoVmSnapshot['id']),
...
// watchEffect(() => {
//   console.log('snapshot collection : ', snapshotsCollection)
//   console.log('selectedSnapshot : ', selectedSnapshot)
//   console.log('lastRevertSnapshot : ', lastRevertSnapshot)
// })
</script>
