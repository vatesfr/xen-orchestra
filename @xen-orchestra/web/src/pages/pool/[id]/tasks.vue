...
import { useXoPoolTasksCollection } from '@/remote-resources/use-xo-pool-tasks-collection.ts'
...
import type { XoPool, XoTask, XoUser } from '@vates/types'
...
const { getTaskById, sortedTasks, hasTaskFetchError, areTasksFetching } = useXoPoolTasksCollection({}, () => pool.id)
