<template>
  <UiCard :has-error="error">
    ...
    <div class="backup-head">
      <template v-if="!areBackupRunsReady">
        <div class="protection-infos">
          ...
          <UiButton
            v-if="!isEmpty || areBackupRunsReady"
    ...
    <VtsTable v-if="!isEmpty || areBackupRunsReady" :state>
      <thead>
        <tr>
          <HeadCells />
        </tr>
...
const areBackupRunsReady = computed(() => !areBackupJobsReady.value || !lastRuns.value)
