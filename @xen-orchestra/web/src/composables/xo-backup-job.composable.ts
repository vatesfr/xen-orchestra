...
export function useXoBackupJob() {
  ...
  function getsettings(backupJob: XoBackupJob) {
    ...
    return {
      proxy: proxy as XoProxy['id'] | undefined,
      mode: mode as 'full' | 'delta',
      nRetriesVmBackupFailures: nRetriesVmBackupFailures as number | undefined,
      timeout: timeout as number | undefined,
      maxExportRate: maxExportRate as number | undefined,
      reportWhen: reportWhen as 'error' | 'failure' | 'always' | 'never' | undefined,
      ...
      checkpointSnapshot: checkpointSnapshot as boolean | undefined,
      offlineSnapshot: offlineSnapshot as boolean | undefined,
      hideSuccessfulItems: hideSuccessfulItems as boolean | undefined,
      timezone: timezone as string | undefined,
      cbtDestroySnapshotData: cbtDestroySnapshotData as boolean | undefined,
      preferNbd: preferNbd as boolean | undefined,
      nbdConcurrency: nbdConcurrency as number | undefined,
      other,
    }
  }
