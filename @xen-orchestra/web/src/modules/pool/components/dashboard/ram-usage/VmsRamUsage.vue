...
import { buildVmsRamProgressItems } from '@/modules/pool/utils/xo-pool-dashboard.util.ts'
import VtsProgressBarGroup from '@core/components/progress-bar-group/VtsProgressBarGroup.vue'
import VtsStateHero from '@core/components/state-hero/VtsStateHero.vue'
import { computed } from 'vue'
import { useI18n } from 'vue-i18n'

// TODO: refactor to use the same component as HostsRamUsage.vue
...
const progressBarItems = computed(() => buildVmsRamProgressItems(topFiveRam ?? []))
</script>
