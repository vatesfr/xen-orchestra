...
export function useSrConnection(options: { srs: MaybeRefOrGetter<FrontXoSr[]>; scope: MaybeRefOrGetter<SrScope> }) {
  ...
  } = useXoPbdPlugJob(connectionTargets)
  ...
  } = useXoPbdUnplugJob(disconnectionTargets)
