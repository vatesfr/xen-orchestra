...
describe('getBackupRepositoryIcon', () => {
  ...
  it('reports an enabled repository without error as connected', () => {
    expect(getBackupRepositoryIcon(createBackupRepository())).toBe(objectIcon('br', 'connected'))
  })
})
