...
export const kubernetesTreeNodes: GroupedFrontXoKubernetesNode[] = [
  {
...
export const kubernetesTreeNamespaces: GroupedFrontXoKubernetesNamespace[] = [
  {
...
export const kubernetesTreePods: GroupedFrontXoKubernetesPod[] = [
  {
