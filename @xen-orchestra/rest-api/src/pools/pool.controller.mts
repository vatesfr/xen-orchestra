...
import type { XoNetwork, XoPif, XoPool, XoVm } from '@vates/types'
import { createVm, partialPools, pool, poolIds } from '../open-api/oa-examples/pool.oa-example.mjs'
import type { CreateNetworkBody, CreateVmAfterCreateParams, CreateVmParams } from './pool.type.mjs'
