<template>
  <UiCard>
    ...
    <VtsLoadingHero v-if="loading || data.stats === undefined || cpuUsage === undefined" type="card" />
...
const valueFormatter: ValueFormatter = value => n(value / 1000, 'percent')
</script>
