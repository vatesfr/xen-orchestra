...
const valueInputBefore = computed(() => (builderComparison.value === 'stringMatchesRegex' ? '/' : undefined))

const valueInputAfter = computed(() => (builderComparison.value === 'stringMatchesRegex' ? '/i' : undefined))
