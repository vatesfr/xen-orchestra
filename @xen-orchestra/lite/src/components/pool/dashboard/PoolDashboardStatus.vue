  ...
  <UiCard class="pool-dashboard-status" :color="hasError ? 'error' : undefined">
    ...
    <template v-else>
      <PoolDashboardStatusItem
        ...
        :label="t('hosts')"
        :active-label="t('host:status:active', activeHostsCount)"
        :inactive-label="t('host:status:inactive', totalHostsCount - activeHostsCount)"
      ...
      <PoolDashboardStatusItem
        ...
        :label="t('vms')"
        :active-label="t('vm:status:active', activeVmsCount)"
        :inactive-label="t('vm:status:inactive', totalVmsCount - activeVmsCount)"
        :total="totalVmsCount"
      />
    </template>
  </UiCard>
