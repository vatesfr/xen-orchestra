...
import type { XenApiVif } from '@/libs/xen-api/xen-api.types.js'
...
import VtsCardRowKeyValue from '@xen-orchestra/web-core/components/card/VtsCardRowKeyValue.vue'
import VtsCardObjectTitle from '@xen-orchestra/web-core/components/card-object-title/VtsCardObjectTitle.vue'
import VtsCopyAllMenuItem from '@xen-orchestra/web-core/components/copy-all-menu-item/VtsCopyAllMenuItem.vue'
import VtsCopyButton from '@xen-orchestra/web-core/components/copy-button/VtsCopyButton.vue'
import VtsSidePanel from '@xen-orchestra/web-core/components/panel/VtsSidePanel.vue'
import VtsStatus from '@xen-orchestra/web-core/components/status/VtsStatus.vue'
import UiCard from '@xen-orchestra/web-core/components/ui/card/UiCard.vue'
import UiCardTitle from '@xen-orchestra/web-core/components/ui/card-title/UiCardTitle.vue'
import { getUniqueIpAddressesForDevice } from '@xen-orchestra/web-core/utils/ip-address.utils.ts'
