...
import type { XenApiNetwork, XenApiVif, XenApiVm } from '@/libs/xen-api/xen-api.types.js'
import { useVifConnectionToggleModal } from '@/modules/vif/composables/use-vif-connection-toggle-modal.composable.js'
...
import { usePagination } from '@xen-orchestra/web-core/composables/pagination.composable'
import { useRouteQuery } from '@xen-orchestra/web-core/composables/route-query.composable'
import { useTableState } from '@xen-orchestra/web-core/composables/table-state.composable'
import { useVifColumns } from '@xen-orchestra/web-core/tables/column-sets/vif-columns'
import { CONNECTION_ACTION } from '@xen-orchestra/web-core/types/connection.ts'
