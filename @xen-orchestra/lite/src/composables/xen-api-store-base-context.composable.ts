...
export const useXenApiStoreBaseContext = <
  XRecord extends XenApiRecord<any>,
>() => {
...
export type XenApiStoreBaseContext<XRecord extends XenApiRecord<any>> =
  ReturnType<typeof useXenApiStoreBaseContext<XRecord>>;
