  ...
  .service 'xo', ($timeout, xoApi, notify) ->
    ...
    xo = {
      ...
      host:
        ...
        new_sr:           action 'New SR' #temp fix before creating SR
        listMissingPatches:       action 'Check available patches', 'host.listMissingPatches', argsMapper: (id) -> {host: id}
        installPatchFromUrl:      action 'Install a patch from a patch URL', 'host.installPatchFromUrl', argsMapper: (id, url) -> {host: id, url}
        # TODO: attach/set
