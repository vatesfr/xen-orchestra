...
module.exports = angular.module 'xoWebApp.services', [
  ...
  .service 'xo', ($timeout, xoApi, notify) ->
    ...
    xo = {
      ...
      host:
        attach:           action 'Attach host'#, 'host.attach'
        ...
        new_sr:           action 'New SR' #temp fix before creating SR
        listMissingPatches:       action 'Check available patches', 'host.listMissingPatches', argsMapper: (host) -> {host}
        installPatch:      action 'Install a patch from a patch UUID', 'host.installPatch', argsMapper: (host, patch) -> {host, patch}
        refreshStats: action 'Get Stats', 'host.stats', notification: false, argsMapper: (host) -> {host}
        # TODO: attach/set
      ...
      vm:
        ...
        refreshStats: action 'Get Stats', 'vm.stats', notification: false, {
          argsMapper: (id) -> {id}
        }
