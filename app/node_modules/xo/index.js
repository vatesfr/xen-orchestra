    ...
    const xo = {
      ...
      resourceSet: {
        create: action('Create a named resource set', 'resourceSet.create', {
          argsMapper: (name, subjects = undefined, objects = undefined, cpuMax = undefined, memoryMax = undefined, diskMax = undefined) => ({
            name, subjects, objects, cpuMax, memoryMax, diskMax
          })
        }),
        ...
        set: action('Set the properties of a resource set', 'resourceSet.set', {
          argsMapper: (id, name = undefined, subjects = undefined, objects = undefined, cpuMax = undefined, memoryMax = undefined, diskMax = undefined) => ({
            id, name, subjects, objects, cpuMax, memoryMax, diskMax
          })
        })
      }
    }
