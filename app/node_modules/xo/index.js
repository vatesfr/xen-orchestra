    ...
    const xo = {
      ...
      resourceSet: {
        create: action('Create a named resource set', 'resourceSet.create', {
          argsMapper: (name, subjects = undefined, objects = undefined) => {
            const args = {name}
            subjects && (args.subjects = subjects)
            objects && (args.objects = objects)
            return args
          }
        }),
        ...
        set: action('Set the properties of a resource set', 'resourceSet.set', {
          argsMapper: (id, name = undefined, subjects = undefined, objects = undefined) => {
            console.log(id, name, subjects, objects)
            const args = {id}
            name && (args.name = name)
            subjects && (args.subjects = subjects)
            objects && (args.objects = objects)
