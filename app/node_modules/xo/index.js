...
export default angular.module('xo', [
  ...
  .service('xo', function ($timeout, xoApi, xoNotify) {
    ...
    const xo = {
      ...
      host: {
        ...
        installPatch:     action('Install a patch from a patch UUID', 'host.installPatch', {
    ...
    ;(function updateCurrentAcls () {
      xoApi.call('acl.getCurrent').then(acls => {
        ...
        forEach(acls, acl => {
          const object = xoApi.get(acl.object)
          if (object) {
    ...
    xo.canAccess = (id) => {
      ...
      return (
        ...
        xoApi.user && (xoApi.user.permission === 'admin') ||
        ...
        (object = xoApi.get(id)) && (object.id in currentAcls)
      )
    }
