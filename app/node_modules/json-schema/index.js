...
.controller('XoEntityInput', function ($scope, xo) {
  const isXoEntity = getXoType(this.property) === 'XoEntity'

  this.ready = false
  this.isRequired = () => isRequired(this.property)
  this.active = () => this.ready && isXoEntity
...
.controller('XoRoleInput', function ($scope, xo) {
  const isXoRole = getXoType(this.property) === 'XoRole'

  this.ready = false
  this.isRequired = () => isRequired(this.property)
  this.active = () => this.ready && isXoRole
