    ...
    function link(scope, element, attrs) {
      ...
      scope.$watch(() => scope.chartData, function (newVal) {
        ...
        g
          .enter()
          .append('path')
          .each(function (d) { this._current = { x: d.x, dx: d.dx, y: d.y, dy: d.dy } }) // store the initial angles

        var existing_and_current = g.attr('display', (d) => d.depth ? null : 'none') // hide inner ring
          .attr('d', arc)
          .style('stroke', '#fff')
        ...
        existing_and_current.each(function (d) {
          if (d.depth > max_depth) {
            max_depth = d.depth
          }
        })
          .filter((d, i) => !!scope.click && !d.non_clickable)
      ...
      function arcTween(a) {
        ...
        return function (t) {
          var b = i(t);
          that._current = { x: b.x, dx: b.dx, y: b.y, dy: b.dy }
          return arc(i(t));
        };
      }
